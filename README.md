...
- The dataset is not include to protect the privacy
...
- The system GUI build have 4 pages:
  - First page is the HOME PAGE
  <p align="center">
    <img width="100%" height="100%" src= "https://github.com/masyitah-abu/Classification-of-Multiple-Visual-Field-Defects-using-CNN/blob/main/GUI/Page_example/Page_1.jpg">
  </p>
  
  - Second page is Menu page to enter the detection page and instruction page
  <p align="center">
    <img width="100%" height="100%" src= "https://github.com/masyitah-abu/Classification-of-Multiple-Visual-Field-Defects-using-CNN/blob/main/GUI/Page_example/Page_2.jpg">
  </p>
  
  - Third page is detection page to detect the defect type and the disease the patient have
  <p align="center">
    <img width="100%" height="100%" src= "https://github.com/masyitah-abu/Classification-of-Multiple-Visual-Field-Defects-using-CNN/blob/main/GUI/Page_example/Page_3.jpg">
  </p>
  
  - Fourth page is Instruction page on how to used this system
  <p align="center">
    <img width="100%" height="100%" src= "https://github.com/masyitah-abu/Classification-of-Multiple-Visual-Field-Defects-using-CNN/blob/main/GUI/Page_example/Page_4.jpg">
  </p>  
